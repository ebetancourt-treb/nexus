{{-- Sidebar navigation items - include this in tenant-layout.blade.php --}}
{{-- Replace the entire <nav class="sidebar-nav"> content with this --}}
...
<nav class="sidebar-nav">
    ...
    <div class="nav-section">
        ...
        <a href="{{ route('tenant.products.index') }}" class="sidebar-link {{ request()->routeIs('tenant.products.*') ? 'active' : '' }}">
            <svg class="sidebar-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m21 7.5-9-5.25L3 7.5m18 0-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25"/></svg>
            Productos
        </a>
    ...
    <div class="nav-section">
        ...
        <a href="{{ route('tenant.movements.create-receiving') }}" class="sidebar-link {{ request()->routeIs('tenant.movements.create-receiving') ? 'active' : '' }}">
            <svg class="sidebar-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 4.5l-15 15m0 0h11.25m-11.25 0V8.25"/></svg>
            Recepción
        </a>
    ...
    <div class="nav-section">
        ...
        @if($showTransfers)
        <a href="#" class="sidebar-link">
            <svg class="sidebar-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5"/></svg>
            Transferencias
        </a>
        @endif
    </div>
   ...
   <div class="nav-section">
        ...
        <a href="{{ route('tenant.profile.edit') }}" class="sidebar-link {{ request()->routeIs('tenant.profile.*') ? 'active' : '' }}">
            <svg class="sidebar-icon" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
            Mi perfil
        </a>
    </div>
</nav>
