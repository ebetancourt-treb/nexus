<x-tenant-layout>
    ...
    <div class="page-actions">
        ...
        <div style="display: flex; gap: 10px;">
            {{-- Botón de Demostración Odoo --}}
            <form action="{{ route('tenant.products.odoo.simular') }}" method="POST" style="margin: 0;">
                @csrf
                <button type="submit" class="btn-primary" style="background: #714B67;" onclick="return confirm('¿Enviar un producto de prueba a Odoo en este momento?')">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 16.5V9.75m0 0l3 3m-3-3l-3 3M6.75 19.5a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z"/></svg>
                    Simular Alta en Odoo
                </button>
            </form>
